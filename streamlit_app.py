...
def cold_call_pitch(lead):
    """Pitch da cold call — 30-60s, variável por tipo de negócio.
    Substitui dados do lead: nome, presença, goal por tipo de negócio."""
...
1️⃣  ABERTURA (15s)
   ...
   "Bom dia, falo com o responsável da {name}?"

   [Se sim]

   "Olá, fala Pedro da Smart Hive Solutions.
    Estive a analisar a presença digital da vossa empresa e reparei
    que têm uma reputação muito forte — vi {presence}, o que demonstra
    claramente confiança do mercado."


2️⃣  MOTIVO (15s) — frase que desarma 👇

   "O motivo da chamada é simples: identifiquei algumas oportunidades
    concretas para transformar essa visibilidade em {goal}.

    Não o estou a contactar para lhe vender nada agora.

    Queria só perceber se faz sentido mostrar-lhe uma análise rápida
    que fiz ao vosso posicionamento digital.

    Tem 2 minutos?"


3️⃣  SE DIZ SIM — DESCOBERTA (ouvir, não interromper)

   "Ótimo. Só para perceber:
    Hoje sentem que a vossa presença digital está a gerar todo o
    potencial de contactos que poderia gerar, ou acredita que ainda
    existe margem para melhorar?"


4️⃣  FECHO (alternativa, nunca aberta)

   "Faz sentido. Pelo que vi, há melhorias estratégicas que podem
    ter impacto real. O ideal seria mostrar-lhe isso com exemplos
    concretos e perceber melhor os vossos objetivos.

    Podemos agendar 15-20 minutos esta semana?

    Quinta às 11h ou sexta às 15h?"

   ❌ Nunca: "Quando lhe dá jeito?"
"""
