...
export default function StatsStrip() {
  ...
  return (
    <section ref={ref} className="bg-rp-ink text-white">
      <div className="container-rp py-16 md:py-20">
...
function StatCell({
  ...
  return (
    <div className="bg-rp-ink p-8 md:p-10 text-center">
      <div className="flex items-baseline justify-center gap-1">
        <span className="font-display text-5xl md:text-6xl text-white tabular-nums">
          {display}
        </span>
        {stat.suffix && (
          <span className="font-display text-3xl md:text-4xl text-rp-gold">
            {stat.suffix}
          </span>
        )}
      </div>
      <div className="mt-4 text-[11px] uppercase tracking-widest2 text-white/85">
        {stat.label}
      </div>
      {stat.sub && (
